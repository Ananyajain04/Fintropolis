    ...
    <div className="w-screen h-screen flex bg-[#01084E] justify-center items-center font-calistoga font-light">
      ...
      <hr className="pb-4"/>
        <div className="flex flex-col justify-center items-center gap-4 w-[80%] mx-auto">
          ...
          <a href="" className="text-xs self-start text-blue-900"> Forgot your password?</a>
          <button onClick={handleHome} className="flex-1 w-full rounded-[10px] bg-[#7426EE] text-white">Login</button>
          <button onClick={handleClick} className="flex-1 w-full rounded-[10px] bg-[#7426EE] text-white">Signup</button>
        </div>
              </Card>
        </div>
      </div>
